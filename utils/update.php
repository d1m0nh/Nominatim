...
$sOsm2pgsqlCmd = CONST_Osm2pgsql_Binary.' --number-processes 1 -C '.$iCacheMemory.' -O gazetteer -S '.CONST_Import_Style.' -d '.$aDSNInfo['database'].' -P '.$aDSNInfo['port'];
...
if (isset($aResult['import-diff']) || isset($aResult['import-file'])) {
    ...
    $sOsm2pgsqlCmd = $sOsm2pgsqlCmd . ' -las --hstore';
